...
- `index.html` (+ `assets/`): the study console. A single-page app, no build step, no external dependencies beyond Google Fonts, with a knowledge base, quiz bank, glossary, and case tracker. Published via GitHub Pages from the repo root.
