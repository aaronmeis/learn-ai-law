...
- `index.html` (+ `assets/`): the study console. A single-page app, no build step, no external dependencies beyond Google Fonts, with a knowledge base, quiz bank, glossary, case tracker, and a dedicated **EU AI products** section (AI in products, AI-assisted product creation, roles, risk tiers, GPAI embeds, conformity, and product liability). Published via GitHub Pages from the repo root.
